import type { Evaluator, IAgentRuntime, Memory, State } from "@ai16z/eliza";
import type { WeatherEvalContent, WeatherEvalResponse } from "./types.ts";
